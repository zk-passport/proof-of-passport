...
cd ..
# install_name_tool -id @rpath/proof_of_passport.framework ${PROJECT_DIR}/ios/MoproKit/Frameworks/proof_of_passport.framework
install_name_tool -id @rpath/proof_of_passport ${PROJECT_DIR}/ios/MoproKit/Frameworks/proof_of_passport.framework/proof_of_passport
